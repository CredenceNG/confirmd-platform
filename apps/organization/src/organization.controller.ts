...
export class OrganizationController {
  ...
  async setPrimaryDid(
    ...
    return this.organizationService.setPrimaryDid(
      payload.orgId,
      payload.did,
      payload.id
    );
  ...
  async createOrgCredentials(
    ...
    return this.organizationService.createOrgCredentials(
      payload.orgId,
      payload.userId,
      payload.keycloakUserId
    );
  ...
  async updateUserRoles(payload: {
    ...
    try {
      ...
      this.logger.error(
        `❌ ORGANIZATION CONTROLLER: Update failed with error: ${JSON.stringify(
          error
        )}`
      );
      throw error;
  ...
  async getOrganizationActivityCount(payload: {
    ...
    return this.organizationService.getOrganizationActivityCount(
      payload.orgId,
      payload.userId
    );
  }
  ...
  async deleteOrganizationCredentials(payload: {
    ...
    return this.organizationService.deleteClientCredentials(
      payload.orgId,
      payload.user
    );
  }
  ...
  async deleteOrganizationInvitation(payload: {
    ...
    return this.organizationService.deleteOrganizationInvitation(
      payload.orgId,
  ...
  async getAgentTypeByAgentTypeId(payload: {
    ...
    return this.organizationService.getAgentTypeByAgentTypeId(
      payload.orgAgentTypeId
    );
  }
