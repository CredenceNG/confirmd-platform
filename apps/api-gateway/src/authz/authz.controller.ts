...
export class AuthzController {
  ...
  @ApiOperation({
    ...
    description:
      "Checks if the provided verification code is valid for the given email.",
  })
  async verifyEmail(
    @Query() query: EmailVerificationDto,
    @Res() res: Response
  ): Promise<Response> {
  ...
  async addUserDetails(
    @Body() userInfo: AddUserDetailsDto,
    @Res() res: Response
  ): Promise<Response> {
  ...
  @ApiOperation({
    ...
    description:
      "Allows users to reset a new password which should be different form existing password.",
  })
  @ApiResponse({
    status: HttpStatus.OK,
    description: "Success",
  ...
  @ApiOperation({
    ...
    description:
      "Resets a user’s password using a verification token sent to their email",
  })
  @ApiResponse({
    status: HttpStatus.OK,
    description: "Success",
  ...
  async resetNewPassword(
    ...
    const userData = await this.authzService.resetNewPassword(
      resetTokenPasswordDto
    );
    const finalResponse: IResponseType = {
      statusCode: HttpStatus.OK,
      message: ResponseMessages.user.success.resetPassword,
  ...
  async refreshToken(
    ...
    const tokenData = await this.authzService.refreshToken(
