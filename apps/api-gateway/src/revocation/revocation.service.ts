...
export class RevocationService extends BaseService {
  ...
  createRevocationRegistry(createRevocationRegistryDto: CreateRevocationRegistryDto, user: any) {
    ...
    return this.natsClient.sendNats(this.revocationServiceProxy as any, 'create-revocation-registry', payload);
  }
  // eslint-disable-next-line @typescript-eslint/explicit-function-return-type
  updateRevocationRegistryUri(updateRevocationRegistryUriDto: UpdateRevocationRegistryUriDto, user: any) {
    ...
    return this.natsClient.sendNats(this.revocationServiceProxy as any, 'update-revocation-registry-uri', payload);
  }
  // eslint-disable-next-line @typescript-eslint/explicit-function-return-type
  activeRevocationRegistry(cred_def_id: string, user: any) {
    ...
    return this.natsClient.sendNats(this.revocationServiceProxy as any, 'active-revocation-registry', payload);
  }
  // eslint-disable-next-line @typescript-eslint/explicit-function-return-type
  publishRevocationRegistry(revocationId: string, user: any) {
    ...
    return this.natsClient.sendNats(this.revocationServiceProxy as any, 'publish-revocation-registry', payload);
  }
 // eslint-disable-next-line @typescript-eslint/explicit-function-return-type
  getRevocationRegistry(rev_reg_id: string, user: any) {
    ...
    return this.natsClient.sendNats(this.revocationServiceProxy as any, 'get-revocation-registry', payload);
  }
}
