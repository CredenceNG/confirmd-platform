...
export class CredentialDefinitionController {
  ...
  async getCredentialDefinitionById(
    ...
    const credentialsDefinitionDetails =
      await this.credentialDefinitionService.getCredentialDefinitionById(
  ...
  async getCredentialDefinitionBySchemaId(
    ...
    if (!schemaId) {
      throw new BadRequestException(
        ResponseMessages.schema.error.invalidSchemaId
      );
    }

    const credentialsDefinitions =
      await this.credentialDefinitionService.getCredentialDefinitionBySchemaId(
        schemaId
      );
    const credDefResponse: IResponse = {
      statusCode: HttpStatus.OK,
  ...
  async getAllCredDefs(
    ...
    const credentialsDefinitionDetails =
      await this.credentialDefinitionService.getAllCredDefs(
        getAllCredDefs,
        user,
        orgId
      );
  ...
  async createCredentialDefinition(
    ...
    credDef.orgId = orgId;
    const credentialsDefinitionDetails =
      await this.credentialDefinitionService.createCredentialDefinition(
        credDef,
        user
      );
    const credDefResponse: IResponse = {
