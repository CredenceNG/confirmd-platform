...
export class SchemaController {
  ...
  async getSchemasDetails(payload: {
    templateIds: string[];
  }): Promise<schema[]> {
  ...
  async getSchemasDetailsBySchemaName(payload: {
    schemaName: string;
    orgId: string;
  }): Promise<ISchemaId[]> {
  ...
  async getSchemas(
    schemaSearch: ISchemaSearchPayload
  ...
  async getSchemaRecordBySchemaId(payload: {
    schemaId: string;
  }): Promise<schema> {
